...
function ExtensionsPage() {
  ...
  const {
    ...
    isLoading,
    installStatus,
  } = useStore(extensionsStore, (state) => state)
      ...
      <div className="container max-w-4xl py-8 px-4 space-y-6">
        ...
        <Card className="card-depth">
          <CardHeader>
            ...
            <CardDescription>
              Install a Pi package from npm, git, or a local path
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="install-local" className="text-sm cursor-pointer">
                Install to project settings (.pi/settings.json) instead of
                global
              </label>
            </div>
