        ...
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <div className="px-2 py-1.5">
              <Badge variant={connectionConfig.variant} className={`${connectionConfig.className} w-full justify-start`}>
                <div className={`size-2 rounded-full mr-2 ${connectionConfig.dotColor}`} />
